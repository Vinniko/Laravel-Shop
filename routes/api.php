...
Route::group(['prefix' => 'products'], function (){
    ...
    Route::get('/search/{query}', [App\Http\Controllers\ProductController::class, 'search'])->middleware(['auth:api']);
    ...
    Route::get('/reindex', [App\Http\Controllers\ProductController::class, 'reindex']);#->middleware(['auth:api']);
});
